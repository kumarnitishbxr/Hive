...
export const useChat = () => {
  ...
  const { data: conversations = [], isLoading } = useQuery({
    ...
    // Fail-safe default conversations
    initialData: [
      {
        _id: 'default-intro',
        title: 'Workspace Initial Audit',
        workspaceId: 'default',
        messages: [
          {
            _id: '1',
            sender: 'ai',
            text: 'I am your AI Co-Founder. Let me know how I can assist with sprint allocations or strategic tasks!',
