...
export const SourcePanel: React.FC<SourcePanelProps> = ({
  ...
  return (
    <div className="w-72 border-l border-white/5 bg-[#111827]/85 backdrop-blur-xl flex flex-col h-full overflow-hidden text-xs font-sans select-none shrink-0 z-20">
      ...
      {/* Pane Content */}
      <div className="grow overflow-y-auto p-4 space-y-5 custom-scrollbar min-h-0">
        {activeTab === 'workspace' ? (
          <>
            {/* Focus area banner */}
            <div className="space-y-1.5 p-3 rounded-xl bg-linear-to-tr from-indigo-500/10 to-purple-500/5 border border-indigo-500/10">
            ...
            <div className="space-y-2.5">
              ...
              <div className="space-y-2">
                {projects.map((p, idx) => (
                  <div key={idx} className="p-3 rounded-xl border border-white/5 bg-white/1 hover:border-white/10 transition space-y-2">
                    <div className="flex justify-between items-center text-[10px]">
                      <span className="font-bold text-gray-200 truncate max-w-37.5">{p.name}</span>
            ...
            <div className="space-y-2.5">
              ...
              <div className={`p-3 rounded-xl border flex items-center gap-2.5 transition duration-300 ${
                blockedTasksCount > 0 
                  ...
                  : 'border-white/5 bg-white/1 text-gray-500'
              }`}>
            ...
            <div className="space-y-2.5">
              ...
              <div className="space-y-1.5">
                <div className="p-2.5 rounded-xl border border-white/5 bg-white/1 text-gray-400 flex items-center gap-2">
